...
var utils = (function () {
	...
	me.momentum = function (current, start, time, lowerMargin, wrapperSize, deceleration) {
		var distance = current - start,
			...
			destination,
			duration; 
			// ,deceleration = this.options.deceleration //0.0006;
...
// INSERT POINT: OPTIONS 
		...
		deceleration: 0.0006 // annam adding option where it used to be hardcoded. this is available in a newer iscroll version 
	};
	...
	/* ANNAM COPIED FROM iscroll-probe.js */
