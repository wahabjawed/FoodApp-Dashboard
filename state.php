...
if($_POST)
	{	
    		...
    		$stmt->execute();
 			...
 			$query = "select* from state order by state_id";
			$stmt = $dbh->prepare($query);
			$stmt->execute();
...
<script>
function link(){
	window.location.href = "state_insert.php"
	}
...
function resets(){
	...
	function deleteConfirm(id)
	{
		...
		if(result == true)
		{	
			this.document.deleteForm.action = "delete.php?id="+id+"&type=state";
...
<div class="container">
 ...
 ?>
  ...
  <div style="margin-bottom:20px;margin-top:20px">
     <form name="search-form" id="search-form" class="form-inline" role="form" enctype="multipart/form-data" method="post" action="state.php">
