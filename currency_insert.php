...
<div class="container">
  ...
  <?PHP
	...
	if($_POST)
	{
		...
		try {
			$query = "INSERT INTO currency_code(currency_code) values (:code);";
  ...
  <a href='#' class='alert-link'>Currency Saved Successfully!</a>
</div>";
...
?>
  ...
  <!-- Jumbotron -->
  <div class="jumbotron">
    <form class="form-horizontal" role="form" method="post" action="currency_insert.php">
